...
export const VideoSliderBounce = forwardRef<
  HTMLDivElement,
  VideoSliderBounceProps
>(
  (
    {
      videos,
    ...
    useEffect(() => {
      ...
      // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [autoplay, currentIndex, duration]);
...
VideoSliderBounce.displayName = "VideoSliderBounce";

export default VideoSliderBounce;
