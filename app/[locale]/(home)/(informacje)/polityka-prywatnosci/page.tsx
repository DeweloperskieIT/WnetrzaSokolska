...
const PrivacyPolicyTextData: PolicySection[] = [
  {
    ...
    description: [
      `Polityka skierowana jest do użytkowników strony internetowej www.wnetrza.deweloperskie.pl`,
    ...
    listItems: [
      ...
      },
      {
        ...
        description: [
          ...
          "Dane osobowe użytkownika, które Administrator przetwarza, to jego: imię, adres e-mail, numer telefonu oraz ewentualne dane osobowe zamieszczone w wiadomości adresowanej do administratora.",
        ],
      },
      {
        text: "Źródło danych.",
      ...
      },
      {
        ...
        additionalDescription: [
          "Odbiorcami Pani/Pana danych – mogą być podmioty zajmujące się hostingiem naszej strony www.wnetrza.deweloperskie.pl oraz ewentualnie podmioty zajmujące się usługami technicznymi dla witryny www.wnetrza.deweloperskie.pl ",
  ...
  },
  {
    ...
    description: [
      ...
      "<ul><li>Inwestycje Deweloperskie Prosta Spółka Akcyjna</li><li>Smart Samurai Krzysztof Kutniowski z siedzibą w Zabrzu</li><li>dostawcy usług serwisowych,</li><li>kancelarie prawne/ przedsiębiorstwa świadczące usługi prawne w zakresie analizy prawnej oraz finansowej na podstawie umowy powierzenia.</li></ul>",
    ],
  },
];
